              ...
              {!drawn ? null : placed.length === 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    {(() => {
                      // "Live TV Event" is only for genuine live events. Movies
                      // (tagged movieAiring, incl. by the TMDb enricher) read
                      // "Movie"; otherwise the blurb or genres, and nothing when
                      // there is nothing to say — never a wrong live-event label.
