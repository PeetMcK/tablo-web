 ...
 */
av_dict_iterate(m: number,prev: number): Promise<number>;
/**
 ...
 */
ff_copyout_dict(dict: number): Promise<Record<string, string>>;
/**
...
AVFormatContext_chapters_a(ptr: number,idx: number): Promise<number>;
AVFormatContext_chapters_a_s(ptr: number,idx: number,val: number): Promise<void>;
...
AVFormatContext_metadata(ptr: number): Promise<number>;
AVFormatContext_metadata_s(ptr: number,val: number): Promise<void>;
AVFormatContext_nb_chapters(ptr: number): Promise<number>;
AVFormatContext_nb_chapters_s(ptr: number,val: number): Promise<void>;
...
AVChapter_end(ptr: number): Promise<number>;
AVChapter_end_s(ptr: number,val: number): Promise<void>;
AVChapter_endhi(ptr: number): Promise<number>;
AVChapter_endhi_s(ptr: number,val: number): Promise<void>;
AVChapter_id(ptr: number): Promise<number>;
AVChapter_id_s(ptr: number,val: number): Promise<void>;
AVChapter_metadata(ptr: number): Promise<number>;
AVChapter_metadata_s(ptr: number,val: number): Promise<void>;
AVChapter_start(ptr: number): Promise<number>;
AVChapter_start_s(ptr: number,val: number): Promise<void>;
AVChapter_starthi(ptr: number): Promise<number>;
AVChapter_starthi_s(ptr: number,val: number): Promise<void>;
AVChapter_time_base_num(ptr: number): Promise<number>;
AVChapter_time_base_den(ptr: number): Promise<number>;
AVChapter_time_base_num_s(ptr: number,val: number): Promise<number>;
AVChapter_time_base_den_s(ptr: number,val: number): Promise<number>;
AVChapter_time_base_s(ptr: number,num: number,den: number): Promise<number>;
 ...
 * @retval NULL               No more elements in the dictionary
 */
av_dict_iterate_sync(m: number,prev: number): number;
/**
 * Set the given entry in *pm, overwriting an existing entry.
 *
 * Note: If AV_DICT_DONT_STRDUP_KEY or AV_DICT_DONT_STRDUP_VAL is set,
 ...
 * @param dict  AVDictionary pointer
 */
ff_copyout_dict_sync(dict: number): Record<string, string>;
/**
 * Reset the internal bitstream filter state. Should be called e.g. when seeking.
 */
...
AVFormatContext_chapters_a_sync(ptr: number,idx: number): number;
AVFormatContext_chapters_a_s_sync(ptr: number,idx: number,val: number): void;
...
AVFormatContext_metadata_sync(ptr: number): number;
AVFormatContext_metadata_s_sync(ptr: number,val: number): void;
AVFormatContext_nb_chapters_sync(ptr: number): number;
AVFormatContext_nb_chapters_s_sync(ptr: number,val: number): void;
...
AVChapter_end_sync(ptr: number): number;
AVChapter_end_s_sync(ptr: number,val: number): void;
AVChapter_endhi_sync(ptr: number): number;
AVChapter_endhi_s_sync(ptr: number,val: number): void;
AVChapter_id_sync(ptr: number): number;
AVChapter_id_s_sync(ptr: number,val: number): void;
AVChapter_metadata_sync(ptr: number): number;
AVChapter_metadata_s_sync(ptr: number,val: number): void;
AVChapter_start_sync(ptr: number): number;
AVChapter_start_s_sync(ptr: number,val: number): void;
AVChapter_starthi_sync(ptr: number): number;
AVChapter_starthi_s_sync(ptr: number,val: number): void;
AVChapter_time_base_num_sync(ptr: number): number;
AVChapter_time_base_den_sync(ptr: number): number;
AVChapter_time_base_num_s_sync(ptr: number,val: number): number;
AVChapter_time_base_den_s_sync(ptr: number,val: number): number;
AVChapter_time_base_s_sync(ptr: number,num: number,den: number): number;
