/**
 * CEA-708 shared helpers, vendored from Shaka Player.
 *
 * Source: shaka-player@5.2.11, `lib/cea/cea_utils.js`. Apache-2.0; the upstream
...
export class CeaUtils {
   ...
   * @param {!Cue} topLevelCue
   * @param {string} stream
   * @param {!Array<!Array<?CeaUtils_StyledChar>>} memory
  ...
  static getParsedCaption(topLevelCue, stream, memory, startTime, endTime,
    ...
    let currentTextColor = CeaUtils_DEFAULT_TXT_COLOR;
    let currentBackgroundColor = CeaUtils_DEFAULT_BG_COLOR;
 ...
 * @enum {number}
 */
export const CeaUtils_CodecFamily = {
  H264: 0,
  H265: 1,
  H266: 2,
};

export class CeaUtils_StyledChar {
  /**
 ...
 * @const {string}
 */
export const CeaUtils_DEFAULT_BG_COLOR = 'black';

/**
 * Default text color.
 * @const {string}
 */
export const CeaUtils_DEFAULT_TXT_COLOR = 'white';

/**
 * NALU type for Supplemental Enhancement Information (SEI) for H.264.
 * @const {number}
 */
export const CeaUtils_H264_NALU_TYPE_SEI = 0x06;

/**
 * NALU type for Supplemental Enhancement Information (SEI) for H.265.
 * @const {number}
 */
export const CeaUtils_H265_PREFIX_NALU_TYPE_SEI = 0x27;

/**
 * NALU type for Supplemental Enhancement Information (SEI) for H.265.
 * @const {number}
 */
export const CeaUtils_H265_SUFFIX_NALU_TYPE_SEI = 0x28;

/**
 * NALU type for Supplemental Enhancement Information (SEI) for H.266.
 * @const {number}
 */
export const CeaUtils_H266_PREFIX_NALU_TYPE_SEI = 0x17;

/**
 * NALU type for Supplemental Enhancement Information (SEI) for H.266.
 * @const {number}
 */
export const CeaUtils_H266_SUFFIX_NALU_TYPE_SEI = 0x18;

/**
 * Default timescale value for a track.
 * @const {number}
 */
export const CeaUtils_DEFAULT_TIMESCALE_VALUE = 90000;
