/**
 * CEA-708 the service state machine, vendored from Shaka Player.
 *
 * Source: shaka-player@5.2.11, `lib/cea/cea708_service.js`. Apache-2.0; the upstream
...
import { Cue } from "./cue";
import { Cea708Window, Cea708Window_TextJustification } from "./cea708Window";
/*! @license
 * Shaka Player
...
export class Cea708Service {
  ...
  handleCea708ControlCode(dtvccPacket) {
    ...
    if (controlCode === Cea708Service_EXT_CEA708_CTRL_CODE_BYTE1) {
  ...
  handleC0_(dtvccPacket, controlCode, pts) {
    ...
    switch (controlCode) {
      case Cea708Service_ASCII_BACKSPACE:
        window.backspace();
        break;
      case Cea708Service_ASCII_CARRIAGE_RETURN:
        ...
        break;
      case Cea708Service_ASCII_HOR_CARRIAGE_RETURN:
        ...
        break;
      case Cea708Service_ASCII_FORM_FEED:
  ...
  setWindowAttributes_(dtvccPacket) {
    ...
    const justification =
      /** @type {!Cea708Window_TextJustification} */ (b3 & 0x03);
  ...
  defineWindow_(dtvccPacket, windowNum, pts) {
    ...
    if (!windowAlreadyExists) {
      const window = new Cea708Window(windowNum, this.serviceNumber_);
      window.setStartTime(pts);
  ...
  rgbColorToCssColor_(red, green, blue) {
    ...
    return Cea708Service_Colors[colorCode];
  }
}
 ...
 */
export const Cea708Service_ASCII_BACKSPACE = 0x08;

/**
 * @private @const {number}
 */
export const Cea708Service_ASCII_FORM_FEED = 0x0c;

/**
 * @private @const {number}
 */
export const Cea708Service_ASCII_CARRIAGE_RETURN = 0x0d;

/**
 * @private @const {number}
 */
export const Cea708Service_ASCII_HOR_CARRIAGE_RETURN = 0x0e;

/**
 * For extended control codes in block_data on CEA-708, byte 1 is 0x10.
 * @private @const {number}
 */
export const Cea708Service_EXT_CEA708_CTRL_CODE_BYTE1 = 0x10;

/**
 * Holds characters mapping for bytes that are G2 control codes.
 * @private @const {!Map<number, string>}
 */
export const Cea708Service_G2Charset = new Map([
 ...
 */
export const Cea708Service_Colors = [
 ...
 */
/* Closure typedef only; declared for us in cea708.d.ts. */
